//contacttype is named as type (another file present already)
...
//   try {
//     const { id } = req.params;
//     const updatedContactType = await ContactType.findByIdAndUpdate(id, req.body, {
//       new: true,
//     });
...
//   try {
//     const deletedContactType = await ContactType.findByIdAndDelete(req.params.id);
